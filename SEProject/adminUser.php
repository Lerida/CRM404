...
Cocomed
 ...
 <style>
      ...
      /*  display: none;  Hidden by default */
        ...
        background-color: #f2e6d9; /* Fallback color */
    ...
    <div id="myModal" class="modal">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <span class="close" onclick="document.location.href='admin.php'">&#10006;</span>
            <div style="text-align:center;">

                <p style="font-family:'Amaranth', sans-serif; padding:5px; padding-bottom:none;color:#ffbf80;"> Fill the form correctly to add a new user to the list.</p>
                <h4 style="font-family:'Stalemate',cursive; font-size:40px; margin-top:20px;margin-bottom: 11px; color: #994d00;">Admin</h4>
        ...
        <form action="" method="POST" style="width:80%;">
            <div style="width:35%;float:left;margin-top:-37px; font-family:'Amaranth', sans-serif;color: #ffbf80;">
            ...
            <input type="button"   style="margin-top:20px; background-color:#808080; float:left;" value="Back" onClick="document.location.href='admin.php'"  class="myButton">
            </div>
